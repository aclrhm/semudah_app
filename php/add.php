...
<div class="container-fluid">
    <div class="row">
        <div class="col-3 kiri">
            ...
            <div class="foto container">
                <div class="satu d-flex">
                    ...
                    height: 40px;">
                    <a href="#" class="mt-2 text-white" style="text-decoration: none;">Tambah Barang</a>
                </div>
                <div class="dua mt-4 d-flex">
                    <img src="../img/Vector (1).svg" alt="" style="width: 40px;
                    height: 40px;">
                    <a href="../index.php" class="mt-2 text-white " style="text-decoration: none;" >Lihat Barang</a>
                </div>
        ...
        <div class="kanan mt-3">
                <h1 style="border-bottom: 3px solid black; padding-bottom: 20px;">Tambah Barang</h1>
                
                <form method="post" action="action_add.php">
                    <p class="input text-center" style="color: #003974;">Form Input Barang</p>
                    <div class="mb-3 mt-5">
                        <input type="name" class="form-control" name="nama" placeholder="Nama Barang" style="border: 1px solid #003974; border-radius: 8px;">
                    </div>
                 
                    <div class="mb-3">
                        <input type="number" class="form-control" name="harga" placeholder="Harga Barang" style="border: 1px solid #003974; border-radius: 8px;">
                    </div>
                 
                    <button type="submit" class="mt-4" value="SAVE" style="background-color:#003974; border:none; color:white; width:100%; height:40px; border-radius:8px;">Submit</button>
                    </form>
            </div>
        </div>
    </div>
